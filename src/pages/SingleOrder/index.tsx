...
import { selectOrdersCurrentItem } from "../../redux/slice/ordersSlice";
import { useAppSelector } from "../../redux/store/hooks";
import { Navigate } from "react-router-dom";
import { ColumnConfig, ProductsOrdered } from "../../utils/types";
import Table from "../../components/ui/Table";
import { currencyFormatter } from "../../utils/currencyFormatter";
import BlankUserProfile from "../../assets/blank-profile-picture.webp"

const SingleOrder = () => {
	const { record, status, error, action } = useAppSelector(
